...
router.get("/authorize", (req, res) => {
    ...
    res.redirect(client.getAuthorizeUrl('activity heartrate location nutrition profile settings sleep social weight', 'https://life-dashboard-api.herokuapp.com/main/fitbit/oauthcallback'));
});

router.get("/oauthcallback", (req, res) => {
    // exchange the authorization code we just received for an access token
    client.getAccessToken(req.query.code, 'https://life-dashboard-api.herokuapp.com/main/fitbit/oauthcallback').then(result => {
